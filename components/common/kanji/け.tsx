...
const Svg = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={109} height={109} {...props}>
    ...
    >
      <path d="M24.67 19.75c1.25 1.5 2.62 3.75 2.12 6.38-3 15.88-6.5 29.5-4.88 44.62 2.02 18.84 2.25 4.75 6.75-3.5M53.67 38.62c2.12 1.38 4.28 1.89 6.88 1.5 8.25-1.25 15.39-2.57 20.62-4 2.76-.74 5.26-1.12 6.88-1.12" />
