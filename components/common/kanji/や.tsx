...
const Svg = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={109} height={109} {...props}>
    ...
    >
      <path d="M18 49.38c1.88 1.62 5.25 2.5 8.62.88C45.13 41.38 62.38 30.88 77.45 31c9.02.14 16.01 4.13 15.93 12.29 0 8.33-10.88 16.58-24.5 17.83M47.13 15.88c5.12.88 10.41 4.05 11.5 6.62 2.12 5-1 2.38-2.88 2.62" />
