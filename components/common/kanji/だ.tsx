...
const Svg = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={109} height={109} {...props}>
    ...
    >
      ...
      <path d="M45 16.88c.75 1.25.87 3.62.38 5.25C39.03 43.07 32.63 58.5 26.5 74.5c-1.36 3.56-4.75 11.75-6 14.62M56.38 53.25c12.38-2.75 18.25-3.7 23.62-3.12 15.12 1.62-1.12 2.25-4.25 4.88M54.13 82.25c4.38 7 14.25 8.12 34.5 5.62M76 22.5c2.75 1.75 6 5.38 7.75 8.5M82.38 17.62c3.06 1.57 6.68 4.82 8.62 7.62" />
    </g>
    <g
      style={{
        fontSize: 8,
