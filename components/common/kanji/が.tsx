...
const Svg = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={109} height={109} {...props}>
    ...
    >
      ...
      <path d="M48.5 17.5c1 1.38 1.29 4.7.5 7.12-5 15.25-18.02 40.93-19.62 43.88C26.26 74.25 23 80.38 20 84.75M77.37 31.62c7.5 6.88 13.25 15.75 15 24.88M80.5 18.25c2.75 1.75 6 5.38 7.75 8.5M86.87 13.38c3.06 1.57 6.68 4.82 8.62 7.62" />
    </g>
    <g
      style={{
        fontSize: 8,
