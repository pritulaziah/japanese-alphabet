...
const Svg = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={109} height={109} {...props}>
    ...
    >
      ...
      <path d="M26.54 34.62c1.12.88 2.87 2.21 6 2 11.12-.75 20-2.12 27.74-3.46 3.88-.67 5.88-1.17 8.88-1.04M26.42 53.38c-1.5 4 1 6.75 7.75 6.75 8.75 0 17.62-1 22.88-1.88 2.01-.33 5.38-1 7.5-1.75" />
    </g>
    <g
      style={{
        fontSize: 8,
