...
const Svg = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={109} height={109} {...props}>
    ...
    >
      ...
      <path d="M41.5 16.12c2.25 1 3.59 4.39 3.12 7.38-2.5 16.12-3.37 45.53-2.25 58.38.75 8.62-.64 10.45-7.12 7.12-5.13-2.62-13.75-8-13.75-12.38C21.5 69.12 45.88 53 66.25 53c17.25 0 25 8.25 25 17.25 0 8.25-9.38 18.88-26.75 21M73 22.12c5.38 2.62 8.88 5.88 10.62 8.25 2.27 3.08.38 4.5-1.12 5" />
    </g>
    <g
      style={{
        fontSize: 8,
